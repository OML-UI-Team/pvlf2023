...
if($_POST) {
    ...
    if(!empty($vote_status)) {
        ...
        $sql = "INSERT INTO pvlf_vote (category_id, product_id, ip, user_agent, session_year) VALUES ('". $_POST['category_id'] ."', '". $_POST['product_id'] ."', '". $ip_address ."','".json_decode($_SERVER['HTTP_USER_AGENT'])."', '2023')";
        $vote = $conn->query($sql);
