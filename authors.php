                            ...
                            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="400ms">
                                <div class="ts-speaker">
                                    <div class="speaker-img">
                                        <img class="img-fluid" src="<?= $site_path.'/'.$product->image ?>" alt="<?= $product->title ?>">

                                    </div>
                                    <div class="ts-speaker-info">
                                        <h3 class="ts-title"> <?= $product->title ?> </h3>
                                    </div>
                                    ...
                                    <div class="text-center voting-area">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <button type="button"
                                                    ...
                                                    <?php } ?>
                                                    class="author-vote-btn btn <?= ($voted == true && !empty($vote_status))?"green-btn":(($voted == false && !empty($vote_status))?"disabled":"vote-active-btn single-product-vote"); ?>">
                                                    <?= ($voted)?"Voted":"Vote"; ?>
                                            </button>
                                            <?php } ?>
                                        <?php } ?>
                                                
                                        <button type="button" class="author-vote-count" id="product-<?= $product->id ?>-vote">
